              ...
              children: [
                ...
                _MyWechatIdCard(
                  ...
                  onCopy: () async {
                    ...
                    if (context.mounted) {
                      WeuiToast.show(context, message: '已复制微信号');
                    }
                  },
                  onQrCode: () {
                    WeuiToast.show(context, message: '我的二维码页面暂未实现');
                  },
                ),
                const SizedBox(height: 12),
                _Section(
                  ...
                  children: [
                    ...
                    _EntryTile(
                      ...
                      onTap: () {
                        WeuiToast.show(context, message: '手机联系人功能暂未实现');
                      },
                      showDivider: false,
                    ),
                  ],
                    ...
                    _EntryTile(
                      ...
                      onTap: () async {
                        ...
                        if (result != null && context.mounted) {
                          WeuiToast.show(context, message: '已创建 AI 好友');
                        }
                      },
                      showDivider: false,
                    ),
